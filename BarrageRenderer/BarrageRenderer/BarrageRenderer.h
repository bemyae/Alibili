...
//! Project version number for BarrageRenderer.
FOUNDATION_EXPORT double BarrageRendererVersionNumber;

//! Project version string for BarrageRenderer.
FOUNDATION_EXPORT const unsigned char BarrageRendererVersionString[];

// In this header, you should import all the public headers of your framework using statements like #import <BarrageRenderer/PublicHeader.h>
